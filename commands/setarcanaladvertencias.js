    ...
    Database.BemVindo .findOne({guilda: message.guild.id}, function(erro, dados) {
        if(!dados){
            let embed = new Discord.MessageEmbed()
                ...
                .setDescription(`**Canal de Advertencia setado com sucesso!\n \n  O canal setada como: **\n${canal}`)
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .setDescription(`**Canal de Advertencia setado com sucesso! <a:verify:687759351330766901> \n \n  O canal setada como: **\n${canal}`)
                .setFooter("Atenciosamente FiveBot © 2020", client.user.avatarURL)
                .setTimestamp();
                message.channel.cache.send(embed).then(msg => msg.delete({ timeout: 5000, reason: 'It had to be done.' }));
                dados.advs = canal.id
                dados.save();
        }
        })
