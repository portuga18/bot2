    ...
    Database.BemVindo .findOne({guilda: message.guild.id}, function(erro, dados) {
        if(!dados){
            let embed = new Discord.RichEmbed()
                ...
                .setDescription(`**Grupo de Advertencia setado com sucesso! O Grupo de 2º Advertencia setada como: **\n${grupo} \n \n Sete o 3º grupo de advertencia use:\n .setarcargoadv3 @grupo`)
            ...
            let embed = new Discord.RichEmbed()
                ...
                .setDescription(`**Grupo de Advertencia setado com sucesso! <a:verify:687759351330766901> \n \n O Grupo de 2º Advertencia setada como: **\n> ${grupo} \n \n Para setar o 3º grupo de advertencia use: ` + "\n ```.setargrupoadv3 @grupo```")
